...
.mega-dropdown-menu .pc-menu-column .dropdown-header > a{
	font-weight: 600;
}
.mega-dropdown-menu .pc-menu-column li.dropdown-header:not(:first-child) {
	margin-top:5px;
}
...
<div class="pc-mob">
	...
	<div class="hide" id="pc-mob-offcanvas">
		...
		<div class="sidebar-offcanvas" role="navigation" id="allcategories">
			<div class="container-fluid sidebar-offcanvas-inner">
				<span class="help-block close" data-toggle="offcanvas" data-target="#allcategories"><i class="fa fa-times fa-2x"></i></span>
				<div class="mega-dropdown-menu">
					...
					<ul class="list-unstyled pc-menu-column">
				    	<?php $counter = 0;?>
		...
		<div class="sidebar-offcanvas" id="searchbar" role="navigation">
			<div class="container-fluid sidebar-offcanvas-inner">
				<span class="help-block close" data-toggle="offcanvas" data-target="#searchbar"><i class="fa fa-times fa-2x"></i></span>
				<div class="mega-dropdown-menu">				

...
<div id="pc-cart-products">
 	<div class="row-fluid text-center">
 		...
 		<h2 class="muted"><?php echo 'Your Order Id is : '.$cart_id;?></h2>	
 	</div>
 	...
 	<div class="row-fluid ">
		...
		<div class='span12'>
			<a class="btn btn-lg btn-primary" href="<?php echo PaycartRoute::_('index.php?option=com_paycart&view=cart&task=unlock&cart_id='.$cart_id.'&'. JSession::getFormToken() .'=1');?>"> &nbsp; <?php echo JText::_("COM_PAYCART_CART_UNLOCK");?></a>
		</div>
	</div>
	<?php endif;?>
</div>

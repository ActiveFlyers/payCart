...
abstract class AdminPage
{
	...
	/**
	 *
	 * @var RbWebdriverTestCase  The test object for invoking test methods.
	 */
	protected $test = null;
...
'Austrlian Parks Add New Menu Item'	=> 'administrator/index.php?option=com_menus&view=item&layout=edit&menutype=parks',
	...
	'Fruit Shop Add New Menu Item'	=> 'administrator/index.php?option=com_menus&view=item&layout=edit&menutype=fruitshop',
			...
			'Paycart'				=> 'administrator/index.php?option=com_paycart',
			'Extension Manage'		=> 'administrator/index.php?option=com_installer&view=manage'
	);
	...
	/**
	 * if you need click on any page's button then use it with xPath
	 */
	public function clickButton($xPath)
	{
		$this->driver->findElement(By::xPath($xPath))->click();	
	}
	
	public function clickToolbar($idOrLabel)
	{
		$return = false;

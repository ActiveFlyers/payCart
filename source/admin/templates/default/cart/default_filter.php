...
<div class="well">
	<div class="row-fluid pc-filter-row">
		...
		<div class="pc-filter-minwidth-100 span1">
			<label><?php echo JText::_('COM_PAYCART_ADMIN_CART_ID')?></label>
			<?php echo paycartHtml::_('paycarthtml.text.filter', 'cart_id', 'cart', $filters, 'filter_paycart',array('class'=>'pc-filter-width'));?>
		</div>				
		<!--<div class="pc-filter-minwidth-150 span1 pc-filter-gap-top">
		...
		<div class="pc-filter-minwidth-150 span2">
			<label><?php echo JText::_('COM_PAYCART_ADMIN_CART_PAID_DATE')?></label>
			<?php echo paycartHtml::_('paycarthtml.range.filter', 'paid_date', 'cart', $filters,'date','filter_paycart',array('style'=>'style="width:90px;"'));?>
		</div>
			
		<div class="pc-filter-minwidth-100 span2">
			<label><?php echo JText::_('COM_PAYCART_ADMIN_PRICE')?></label>
			<?php echo paycartHtml::_('paycarthtml.range.filter', 'price', 'cart', $filters,'text','filter_paycart');?>
		</div>

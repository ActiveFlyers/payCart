...
<tbody>
<tr>
<td height="65" align="center" style="font-size:21px;color:#000000;font-weight:normal">ORDER DISPATCHED</td>
</tr>
<tr>
<td style="color: #2c2c2c; display: block; line-height: 20px; font-weight: 300; margin: 0 auto; clear: both; border-bottom: 1px solid #e6e6e6; border-top: 1px solid #e6e6e6; background-color: #ededed; padding: 20px;" align="left" bgcolor="#ededed" valign="top">
...
<p style="padding: 0; margin: 0; color: #565656; font-size: 13px;">We have dispatched one or more items in your order no. [[order_id]] </p>
<br>
<p style="text-align: center; padding: 0; margin: 0;" align="center"><a style="width: 200px; margin: 0px auto; background: linear-gradient(to bottom,#007fb8 1%,#6ebad5 3%,#007fb8 7%,#007fb8 100%); background-color: #007fb8; text-align: center; border: #004b91 solid 1px; padding: 8px 0; text-decoration: none; border-radius: 2px; display: block; color: #fff; font-size: 13px;" href="[[order_url]]" target="_blank"><span style="color: #ffffff; font-size: 13px; background-color: #007fb8;">TRACK ORDER</span></a></p>
</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
<td style="font-size: 14px; color: rgb(93, 93, 93); font-weight: normal; padding:15px;" height="40"><span style="  font-size: 16px; color: #000000; font-weight: normal;">PRODUCT(S) DISPATCHED
</span></td>
</tr>
<tr>

...
<div class="well">
	<div class="row-fluid">
		<div class="span10">
			<img class="pc-account-header-avatar img-polaroid pull-left" src="<?php echo "http://www.gravatar.com/avatar/" . md5( strtolower( trim( $buyer->getEmail() ) ) ) . "?size=48";?>" alt="<?php echo $buyer->getRealName();?>">						
			<h3 class="pc-account-header-name"><?php echo $buyer->getRealName();?></h3>
			<ul class="pc-account-header-details inline muted text-shadow-white hidden-phone">
		...
		<div class="span2 pull-right text-right pc-account-header-logout">

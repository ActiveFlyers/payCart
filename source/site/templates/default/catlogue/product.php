...
$catlogue = include JPATH_ROOT.'/test/_data/ux/products.php';

?>
<div class='pc-categories-wrapper'>
<div class='pc-categories js-masonry'
  	data-masonry-options='{ "itemSelector": ".pc-category-outer" }'>
		...
		<div class='pc-category blurground' style="background-image: url('<?php echo $c['cover_media'];?>');">
			<div class="pc-category-inner blurground vertical-center-wrapper" >
				<div class="pc-category-content">
					<h2 class="vertical-center-content"><a href="#"><?php echo $c['title'];?></a></h2>
				</div>
			</div>
		</div>
	</div>

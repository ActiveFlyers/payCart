...
<div id="pc-cart-complete-paid">
 	<div class="row-fluid">
 		<div class="span12 center">
 			<?php if($payment_status == PaycartHelperInvoice::STATUS_TRANSACTION_PAYMENT_COMPLETE):?>
	 			...
	 			<div class="muted"><em><?php echo JText::_('COM_PAYCART_CART_COMPLETE_PAID_ORDER_PROCESSING');?></em></div>
	 		<?php elseif($payment_status == PaycartHelperInvoice::STATUS_TRANSACTION_PAYMENT_PENDING):?>
	 			...
	 			<div class="muted"><em><?php echo JText::_('COM_PAYCART_CART_COMPLETE_INPROCESS_ORDER_PROCESSING');?></em></div>
	 		<?php else :?>
	 			<h1 class="text-error"><?php echo JText::_('COM_PAYCART_CART_COMPLETE_FAILED_MSG');?></h1>
	 			<div class="muted"><em><?php echo JText::_('COM_PAYCART_CART_COMPLETE_FAILED_ORDER_PROCESSING');?></em></div>
	 		<?php endif;?>
	 		<hr/>
 		</div>
 	</div>
 	...
 	<div class="row-fluid">
 		<div class="span5">
			<a href="<?php echo JRoute::_('index.php?option=com_paycart&view=productcategory&task=display');?>" class="btn btn-large input-block-level btn-info"><?php echo JText::_('COM_PAYCART_KEEP_SHOPPING');?></a> 		
 		</div>
 		<div class="span2">
 			<h4 class="muted center"><?php echo JText::_('COM_PAYCART_OR');?></h4>
 		</div>
 		<div class="span5">

...
<fieldset>
  	<div class="control-group">	
	 	<div class="control-label">
 			<label id="paycart_cart_address_shipping_zipcode-lbl" for="paycart_cart_address_shipping_zipcode" class="required"><?php echo JText::_('ZIP code'); ?></label>
 		</div>
 		<div class="controls">
			...
			<span class="pc-error" for="paycart_cart_address_shipping_zipcode"><?php echo JText::_('Error');?></span>
		</div>
	</div>

	<div class="control-group">	
	 	<div class="control-label">
 			<label id="paycart_cart_address_shipping_to-lbl" for="paycart_cart_address_shipping_to" class="required"><?php echo JText::_('Full Name'); ?></label>
 		</div>
 		<div class="controls">
			...
			<span class="pc-error" for="paycart_cart_address_shipping_to"><?php echo JText::_('Error');?></span>
		</div>
	</div>
	
	<div class="control-group">	
	 	<div class="control-label">
 			<label id="paycart_cart_address_shipping_phone1-lbl" for="paycart_cart_address_shipping_phone1" class="required"><?php echo JText::_('Phone Number'); ?></label>
 		</div>
 		<div class="controls">
			...
			<span class="pc-error" for="paycart_cart_address_shipping_phone1"><?php echo JText::_('Error');?></span>
		</div>
	</div>
				
	<div class="control-group">	
	 	<div class="control-label">
 			<label id="paycart_shipping_country_id-lbl" for="paycart_shipping_country_id" class="required"><?php echo JText::_('Select Country'); ?></label>
 		</div>
 		<div class="controls">		 			
			...
			<span class="pc-error" for="paycart_shipping_country_id"><?php echo JText::_('Error');?></span>
		</div>
	</div>
	...
	<div class="control-group">	
	 	<div class="control-label">
 			<label id="paycart_shipping_state_id-lbl" for="paycart_shipping_state_id" class="required"><?php echo JText::_('Select State'); ?></label>
 		</div>
 		<div class="controls">		 			
			...
			<span class="pc-error" for="paycart_shipping_state_id"><?php echo JText::_('Error');?></span>
		</div>
	</div>
	
	<div class="control-group">	
	 	<div class="control-label">
 			<label id="paycart_cart_address_shipping_city-lbl" for="paycart_cart_address_shipping_city" class="required"><?php echo JText::_('Town/City'); ?></label>
 		</div>
 		<div class="controls">
			...
			<span class="pc-error" for="paycart_cart_address_shipping_city"><?php echo JText::_('Error');?></span>
		</div>
	</div>
	
	<div class="control-group">	
	 	<div class="control-label">
 			<label id="paycart_cart_address_shipping_address-lbl" for="paycart_cart_address_shipping_address" class="required"><?php echo JText::_('Address'); ?></label>
 		</div>
 		<div class="controls">
			...
			<span class="pc-error" for="paycart_cart_address_shipping_address"><?php echo JText::_('Error');?></span>
		</div>
	</div>
</fieldset>

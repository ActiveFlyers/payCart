...
<fieldset>
	...
	<div class="control-group">	
 		...
 		<div class="controls">
			<input type="text" name="paycart_cart_address[shipping][vat_number]" id="paycart_cart_address_shipping_vat_number" class="input-block-level" value="<?php echo @$shipping_address->vat_number; ?>"/>
		</div>
	</div>
</fieldset>

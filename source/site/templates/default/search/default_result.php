...
<!-- ==================================================================
	...
	<div class="row-fluid">
		...
		<div class="pull-right">
			<?php echo PaycartHtml::_('select.genericlist',$sortingOptions, 'filter_sort', 'onChange="paycart.product.filterResult()" data-pc-filter="sort-source"','','',$appliedSort);?>
		</div>
	</div>
	...
	<div class="row-fluid">
		...
		<div class="span4 pc-product-filter">
			<form class="pc-form-product-filter" method="post">
				...
				<?php foreach ($filters->custom->filterHtml as $id=>$filter):?>
				...
				<input type="checkbox" name="filters[core][in_stock]" value="In-Stock" onChange="paycart.product.filterResult()"
			...
			<div class="span8 clearfix">
				...
				<?php if($count >= $start):?>
					<div class="text-center pc-loadMore">
						<button class="btn btn-large" onClick="paycart.product.loadMore();">
